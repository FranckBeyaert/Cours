          ...
          <div className="gutter-box">
              <Card
                  ...
                  cover={
                      <img
                          alt={Title}
                          src={Poster === 'N/A' ? "../public/NotFound.jpg" : Poster}
                      />
                  }
          ...
          <Layout className="layout">
              <Header>
                  <div style={{ textAlign: 'center'}}>
                      <TextTitle style={{color: '#ffffff', marginTop: '14px'}} level={3}>OMDB API + ReactJs + AntDesign</TextTitle>
                  </div>
              </Header>
